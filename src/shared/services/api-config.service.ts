...
export class ApiConfigService {
  ...
  get minioS3Config() {
    return {
      username: this.getString("MINIO_ROOT_USER"),
      password: this.getString("MINIO_ROOT_PASSWORD"),
      port: this.getNumber("MINIO_PORT"),
      uiPort: this.getNumber("MINIO_UI_PORT"),
      host: this.getString("MINIO_HOST"),
      hostname: this.getString("MINIO_HOSTNAME"),
    };
  }
